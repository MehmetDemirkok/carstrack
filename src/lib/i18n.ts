...
export const translations = {
  tr: {
    ...
    settings_timezone_desc: "Günlük filo özeti e-postası yerel saat 09:00'da gelir",
    timezone_title: "Saat Dilimi Seç",
    timezone_saved: "Saat dilimi güncellendi",
  ...
  en: {
    ...
    settings_timezone_desc: "Daily fleet digest arrives at 9:00 AM local time",
    timezone_title: "Select Time Zone",
    timezone_saved: "Time zone updated",
